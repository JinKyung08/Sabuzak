        ...
        <section>
          ...
          <div class="my_div my_bg"> 
                <div class="index-mid" >
                    ...
                    <!-- 검색창-->
                    <form action="${path}/Board/notice" method="get">
                    <div class="search-group" style="padding-top: 10px;">
                        <div class="input-group rounded-pill" style="background-color: white;">
                            <span class="input-group-text">
                              <i class="ai-search"></i>
                            </span>
                            <input type="search"  id="searchValue" class="form-control" placeholder="검색..." name="searchValue" value="${param.searchValue}" >
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="btn-add" onclick="location.href='${path}/Board/write?type=${notice}'"> 
                    ...
                    <div class="table-responsive-notice">
                        <table class="tableNotice" id="type" style="margin-bottom: 0px">
                        <thead>
                            <tr>
                            <th>번호</th>
                            <th>제목</th>
...
<nav aria-label="Page navigation notice" style="text-align: center;">
  <ul class="pagination" >
    <li class="page-item">
      <a href="javascript:void(0);"onclick="movePage('${path}/Board/notice?page=1');" class="page-link">
    ...
    <c:if test="${status.current != pageInfo.currentPage}">
			 <a href="javascript:void(0);" onclick="movePage('${path}/Board/notice?page=${status.current}');" class="page-link">${status.current}</a>
		</c:if>
	</c:forEach>
   <!-- <li class="page-item d-none d-sm-block" >
    ...
    <li class="page-item">
      <a href="javascript:void(0);" onclick="movePage('${path}/Board/notice?page=${pageInfo.maxPage}');" class="page-link">
        Next&nbsp;&nbsp;
